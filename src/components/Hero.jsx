...
const Hero = () => {
    return (
        <section className="h-screen bg-center flex items-center justify-center relative"
        ...
        className="relative z-10 bg-white/10 backdrop-blur-lg p-12 rounded-2xl text-center text-black max-w-3xl shadow-2xl border border-white">
